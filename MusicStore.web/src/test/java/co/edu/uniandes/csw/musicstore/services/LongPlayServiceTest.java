...
public class LongPlayServiceTest {
    ...
    public static final String PATH = "/longPlays";
    ...
    public static WebArchive createDeployment() {
        ...
        return ShrinkWrap.create(WebArchive.class, DEPLOY)
                ...
                .addPackage(LongPlayService.class.getPackage())
    ...
    public static List<LongPlayDTO> data = new ArrayList<>();

    private static LongPlayDTO createTestObject() {

        PodamFactory factory = new PodamFactoryImpl();
        LongPlayDTO testObject = factory.manufacturePojo(LongPlayDTO.class);
        return testObject;
    }
    ...
    public static void insertData() {
        ...
        for (int i = 0; i < 5; i++) {
            LongPlayDTO dto = createTestObject();
            data.add(dto);
    ...
    @Test
    @RunAsClient
    public void createLongPlayTest() throws IOException {
        try {
            ...
            if (auth != null) {
                ...
                LongPlayDTO result = (LongPlayDTO) response.readEntity(LongPlayDTO.class);
    ...
    @Test
    @RunAsClient
    public void getLongPlaysTest() throws IOException {
        try {
            Cookie auth = getAuthorization();
            if (auth != null) {
                ...
                System.out.println(response.toString());
                List<LongPlayDTO> list = new ObjectMapper().readValue(response.readEntity(String.class), List.class);
    ...
    public void getLongPlayTest() {
        try {
            ...
            if (auth != null) {
                ...
                Client cliente = ClientBuilder.newClient();
                LongPlayDTO dto = cliente.target(URLBASE + PATH).path("/" + data.get(0).getId()).request().cookie(auth).get(LongPlayDTO.class);
    ...
    @Test
    @RunAsClient
    public void updateLongPlayTest() throws IOException {
        try {
            Cookie auth = getAuthorization();
            if (auth != null) {
                LongPlayDTO dto = data.get(0);
                LongPlayDTO changed = createTestObject();
                ...
                LongPlayDTO test = (LongPlayDTO) response.readEntity(LongPlayDTO.class);
