(function(ng) {
    ...
    mod.controller(cCtrl, [cc, '$scope', '$route', lpSvc, lpMod, ciSvc, '$location', cSvc, qSvc,
        function(CrudCreator, $scope, $route, svc, model, cartItemSvc, $location, commentService, questionService) {
            ...
            this.recordActions = [{name: 'addToCart', displayName: 'Add to Cart', icon: 'shopping-cart', class: 'primary',
                ...
                {name: 'addQuestion', displayName: 'Add Question', icon: 'question-sign', class: 'info',
                    fn: function(record) {
