...
public class CommentServiceTest {
    ...
    public static List<CommentDTO> data = new ArrayList<>();

    private static CommentDTO createTestObject() {

        PodamFactory factory = new PodamFactoryImpl();
        CommentDTO testObject = factory.manufacturePojo(CommentDTO.class);
        return testObject;
    }
    ...
    public static void insertData() {
        ...
        for (int i = 0; i < 5; i++) {
            CommentDTO dto = createTestObject();
            data.add(dto);
    ...
    public void createCommentTest() throws IOException {
        try {
            ...
            if (auth != null) {
                ...
                CommentDTO result = (CommentDTO) response.readEntity(CommentDTO.class);
    ...
    public void getCommentsTest() throws IOException {
        try {
            ...
            if (auth != null) {
                ...
                System.out.println(response.toString());
                List<CommentDTO> list = new ObjectMapper().readValue(response.readEntity(String.class), List.class);
    ...
    public void getCommentTest() {
        try {
            ...
            if (auth != null) {
                ...
                Client cliente = ClientBuilder.newClient();
                CommentDTO dto = cliente.target(URLBASE + PATH).path("/" + data.get(0).getId()).request().cookie(auth).get(CommentDTO.class);
    ...
    public void updateCommentTest() throws IOException {
        try {
            ...
            if (auth != null) {
                CommentDTO dto = data.get(0);
                CommentDTO changed = createTestObject();
                ...
                CommentDTO test = (CommentDTO) response.readEntity(CommentDTO.class);
